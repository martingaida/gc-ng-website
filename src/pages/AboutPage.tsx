		...
		<>
					...
					<ul className="mt-12 grid gap-10 md:grid-cols-2 lg:grid-cols-3">
						{about.values.map((value) => (
							<li key={value.title} className="border-t border-border pt-5">
								...
								<p className="mt-3 text-foreground/90">{value.body}</p>
							</li>
						))}
					</ul>
				</div>
			...
			<section className="section-pad bg-surface">
				<div className="site-container grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
					...
					/>
					<div>
						<ul className="flex flex-col gap-4 text-foreground/90">
						...
						<p className="mt-8 text-lg text-foreground">{about.resonanceClose}</p>
					</div>
				</div>
			</section>
			...
			<section className="section-pad bg-background">
				<div className="site-container grid gap-12 md:grid-cols-2 md:gap-16">
					<div>
						...
						<ul className="mt-6 flex flex-col gap-3 text-foreground/90">
