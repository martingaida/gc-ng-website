...
The search script is vendored in this repository. Always invoke it from the repository root with the path below — do not use `${CLAUDE_PLUGIN_ROOT}` or a Claude plugin skills layout:
...
# Step 3: supplement
python skills/ui-ux-pro-max/scripts/search.py "keyboard focus modal" --domain ux
