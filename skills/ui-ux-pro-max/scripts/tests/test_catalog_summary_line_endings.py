...
REPO = _find_upstream_repo()
DATA = REPO / "src/ui-ux-pro-max/data" if REPO else None
_SKIP_UPSTREAM = "upstream generate-catalog-summary.py is not vendored with this skill"
SNAPSHOT_FILES = (
    "google-fonts.csv",
...
@unittest.skipIf(REPO is None, _SKIP_UPSTREAM)
